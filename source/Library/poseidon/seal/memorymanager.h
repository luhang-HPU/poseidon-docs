...
{
    /**
    Manages a shared pointer to a memory pool. Microsoft POSEIDON uses memory pools
    ...
    Microsoft POSEIDON provides overloads of the functions that take a MemoryPoolHandle
    ...
    */
    ...
    the global memory pool. Microsoft POSEIDON uses this memory manager profile by default.
    */
    ...
    */
    ...
    public:
        ...
        */
        ...
        POSEIDON_NODISCARD static inline MemoryPoolHandle GetPool(mm_prof_opt_t prof_opt, Args &&... args)
        {
            switch (prof_opt)
            {
    ...
    private:
        POSEIDON_NODISCARD static inline std::unique_ptr<MMProf> SwitchProfileThreadUnsafe(MMProf *&&mm_prof)
        {
            if (!mm_prof)
            {
        ...
        POSEIDON_NODISCARD static inline std::unique_ptr<MMProf> SwitchProfileThreadUnsafe(

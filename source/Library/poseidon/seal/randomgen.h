...
namespace poseidon
{
    ...
    */
    ...
    public:
        ...
        */
        POSEIDON_NODISCARD inline bool operator==(const UniformRandomGeneratorInfo &compare) const noexcept
        {
        ...
        */
        POSEIDON_NODISCARD inline prng_type scheme() const noexcept
        {
            return type_;
        }
        ...
        */
        POSEIDON_NODISCARD inline prng_type &scheme() noexcept
        {
            return type_;
        }
        ...
        */
        POSEIDON_NODISCARD inline const prng_seed_type &seed() const noexcept
        {
            return seed_;
        }
        ...
        Returns a reference to the PRNG seed.
        */
        POSEIDON_NODISCARD inline prng_seed_type &seed() noexcept
        {
            return seed_;
        }
        ...
        */
//        POSEIDON_NODISCARD static inline std::streamoff SaveSize(
...
//        }
    ...
    */
    ...
    public:
        ...
        */
        POSEIDON_NODISCARD inline bool use_random_seed() noexcept
        {
        ...
        */
        POSEIDON_NODISCARD inline prng_seed_type default_seed() noexcept
        {
            return default_seed_;
        }

    protected:
        POSEIDON_NODISCARD virtual auto create_impl(prng_seed_type seed) -> std::shared_ptr<UniformRandomGenerator> = 0;
    ...
    */
    ...
    protected:
        POSEIDON_NODISCARD prng_type scheme() const noexcept override
        {
    ...
    protected:
        POSEIDON_NODISCARD auto create_impl(prng_seed_type seed) -> std::shared_ptr<UniformRandomGenerator> override
        {

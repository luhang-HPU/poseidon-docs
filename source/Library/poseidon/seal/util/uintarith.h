...
namespace poseidon
{
    namespace util
    {
        ...
        POSEIDON_NODISCARD inline unsigned char add_uint64_generic(
        ...
        template <typename T, typename S, typename = std::enable_if_t<is_uint64_v<T, S>>>
        POSEIDON_NODISCARD inline unsigned char add_uint64(
            T operand1, S operand2, unsigned char carry, unsigned long long *result)
        {
        ...
        template <typename T, typename S, typename = std::enable_if_t<is_uint64_v<T, S>>>
        POSEIDON_NODISCARD inline unsigned char sub_uint64_generic(
        ...
        template <typename T, typename S, typename = std::enable_if_t<is_uint64_v<T, S>>>
        POSEIDON_NODISCARD inline unsigned char sub_uint64(
            T operand1, S operand2, unsigned char borrow, unsigned long long *result)
        {
        ...
        POSEIDON_FORCE_INLINE void multiply_accumulate_uint64(
        ...
        template <>
        POSEIDON_FORCE_INLINE void multiply_accumulate_uint64<0>(
            POSEIDON_MAYBE_UNUSED const std::uint64_t *operand1, POSEIDON_MAYBE_UNUSED const std::uint64_t *operand2,
        ...
        POSEIDON_NODISCARD std::uint64_t exponentiate_uint_safe(std::uint64_t operand, std::uint64_t exponent);

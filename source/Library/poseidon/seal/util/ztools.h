...
namespace poseidon
{
    namespace util
    {
        ...
        {
            /**
            Compresses data in the given buffer, completes the given POSEIDONHeader by writing in the size of the output and
            setting the compression mode to compr_mode_type::zlib and finally writes the POSEIDONHeader followed by the
            ...
            */
            ...
            /**
            Compresses data in the given buffer, completes the given POSEIDONHeader by writing in the size of the output and
            setting the compression mode to compr_mode_type::zstd and finally writes the POSEIDONHeader followed by the
            compressed data in the given stream.
            ...
            */
            ...
            POSEIDON_NODISCARD SizeT zlib_deflate_size_bound(SizeT in_size)
            {
                return util::add_safe<SizeT>(in_size, in_size >> 12, in_size >> 14, in_size >> 25, SizeT(17));
            }

            template <typename SizeT>
            POSEIDON_NODISCARD SizeT zstd_deflate_size_bound(SizeT in_size)
            {

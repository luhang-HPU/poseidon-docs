...
namespace poseidon
{
    namespace util
    {
        ...
        public:
            ...
            template <typename RNG>
            POSEIDON_NODISCARD inline result_type operator()(RNG &engine) noexcept
            {
            ...
            POSEIDON_NODISCARD inline result_type mean() const noexcept
            {
                return normal_.mean();
            }
            ...
            POSEIDON_NODISCARD inline result_type max_deviation() const noexcept
            {
            ...
            POSEIDON_NODISCARD inline param_type param() const noexcept
            {
                return *this;
            }

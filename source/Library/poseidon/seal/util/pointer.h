...
#include "poseidon/seal/util/mempool.h"
#include <iterator>
#include <memory>
#include <type_traits>
#include <utility>
...
namespace poseidon
{
    namespace util
    {
        ...
        template <>
        class POSEIDON_NODISCARD Pointer<seal_byte>
        {
        ...
        public:
            ...
            POSEIDON_NODISCARD inline seal_byte &operator[](std::size_t index)
            {
                return data_[index];
            }

            POSEIDON_NODISCARD inline const seal_byte &operator[](std::size_t index) const
            {
                return data_[index];
            }
            ...
            POSEIDON_NODISCARD inline bool is_set() const noexcept
            {
                return data_ != nullptr;
            }

            POSEIDON_NODISCARD inline seal_byte *get() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline seal_byte *operator->() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline seal_byte &operator*() const
            {
                return *data_;
            }

            POSEIDON_NODISCARD inline bool is_alias() const noexcept
            {
                return alias_;
            }
            ...
            POSEIDON_NODISCARD explicit operator bool() const noexcept
            {
                return (data_ != nullptr);
            }

            POSEIDON_NODISCARD inline static Pointer<seal_byte> Owning(seal_byte *pointer) noexcept
            {
                return { pointer, false };
            }

            POSEIDON_NODISCARD inline static auto Aliasing(seal_byte *pointer) noexcept -> Pointer<seal_byte>
            {
                return { pointer, true };
            }
        ...
        class POSEIDON_NODISCARD Pointer
        {
            friend class MemoryPoolST;
            friend class MemoryPoolMT;
        ...
        public:
            ...
            POSEIDON_NODISCARD inline T &operator[](std::size_t index)
            {
                return data_[index];
            }

            POSEIDON_NODISCARD inline const T &operator[](std::size_t index) const
            {
                return data_[index];
            }
            ...
            POSEIDON_NODISCARD inline T *get() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline T *operator->() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline T &operator*() const
            {
                return *data_;
            }
        ...
        // Specialization for seal_byte
        template <>
        class POSEIDON_NODISCARD ConstPointer<seal_byte>
        {
            friend class MemoryPoolST;
            friend class MemoryPoolMT;
        ...
        public:
            ...
            POSEIDON_NODISCARD inline const seal_byte *get() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline const seal_byte *operator->() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline const seal_byte &operator*() const
            {
                return *data_;
            }
            ...
            POSEIDON_NODISCARD explicit operator bool() const
            {
                return (data_ != nullptr);
            }

            POSEIDON_NODISCARD inline static auto Owning(seal_byte *pointer) noexcept -> ConstPointer<seal_byte>
            {
                return { pointer, false };
            }

            POSEIDON_NODISCARD inline static auto Aliasing(const seal_byte *pointer) noexcept -> ConstPointer<seal_byte>
            {
        ...
        template <typename T, typename>
        class POSEIDON_NODISCARD ConstPointer
        {
            friend class MemoryPoolST;
            friend class MemoryPoolMT;
        ...
        public:
            ...
            POSEIDON_NODISCARD inline const T *get() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline const T *operator->() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline const T &operator*() const
            {
                return *data_;
            }

...
#include "poseidon/seal/util/uintarith.h"
#include <cstdint>
#include <type_traits>
...
namespace poseidon
{
    namespace util
    {
        ...
        */
        POSEIDON_NODISCARD inline std::uint64_t increment_uint_mod(std::uint64_t operand, const Modulus &modulus)
        {
        ...
        */
        POSEIDON_NODISCARD inline std::uint64_t decrement_uint_mod(std::uint64_t operand, const Modulus &modulus)
        {
#ifdef POSEIDON_DEBUG
            if (modulus.is_zero())
            {
        ...
        */
        POSEIDON_NODISCARD inline std::uint64_t negate_uint_mod(std::uint64_t operand, const Modulus &modulus)
        {
#ifdef POSEIDON_DEBUG
            if (modulus.is_zero())
            {
        ...
        */
        POSEIDON_NODISCARD inline std::uint64_t add_uint_mod(
        ...
        */
        POSEIDON_NODISCARD inline std::uint64_t sub_uint_mod(
            std::uint64_t operand1, std::uint64_t operand2, const Modulus &modulus)
        {
#ifdef POSEIDON_DEBUG
            if (modulus.is_zero())
...
#endif
            unsigned long long temp;
            std::int64_t borrow = static_cast<std::int64_t>(POSEIDON_SUB_BORROW_UINT64(operand1, operand2, 0, &temp));
        ...
        */
        POSEIDON_NODISCARD inline std::uint64_t multiply_uint_mod(
            std::uint64_t operand1, std::uint64_t operand2, const Modulus &modulus)
        {
#ifdef POSEIDON_DEBUG
            if (modulus.is_zero())
        ...
        */
        ...
        Correctness: modulus should be at most 63-bit, and y must be less than modulus.
        */
        POSEIDON_NODISCARD inline std::uint64_t multiply_uint_mod_lazy(
            std::uint64_t x, MultiplyUIntModOperand y, const Modulus &modulus)
        {
#ifdef POSEIDON_DEBUG
            if (y.operand >= modulus.value())
        ...
        */
        ...
        Correctness: Follows the condition of barrett_reduce_128.
        */
        POSEIDON_NODISCARD inline std::uint64_t modulo_uint(
        ...
        */
        ...
        Correctness: Follows the condition of barrett_reduce_128.
        */
        POSEIDON_NODISCARD std::uint64_t exponentiate_uint_mod(
        ...
        */
        ...
        Correctness: Follows the condition of barrett_reduce_128.
        */
        POSEIDON_NODISCARD std::uint64_t dot_product_mod(

...
namespace poseidon
{
    namespace util
    {
        namespace ztools
        {
            ...
            {
                Serialization::POSEIDONHeader &header = *reinterpret_cast<Serialization::POSEIDONHeader *>(header_ptr);
                ...
                try
                {
                    ...
                    out_stream.write(reinterpret_cast<const char *>(&header), sizeof(Serialization::POSEIDONHeader));

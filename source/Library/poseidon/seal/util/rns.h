...
namespace poseidon
{
    namespace util
    {
        ...
        public:
            ...
            POSEIDON_NODISCARD inline const Modulus *base() const noexcept
            {
                return base_.get();
            }
            ...
            POSEIDON_NODISCARD inline const MultiplyUIntModOperand *inv_punctured_prod_mod_base_array() const noexcept
            {
        ...
        public:
            ...
            POSEIDON_NODISCARD inline std::size_t ibase_size() const noexcept
            {
                return ibase_.size();
            }

            POSEIDON_NODISCARD inline std::size_t obase_size() const noexcept
            {
                return obase_.size();
            }

            POSEIDON_NODISCARD inline const RNSBase &ibase() const noexcept
            {
                return ibase_;
            }

            POSEIDON_NODISCARD inline const RNSBase &obase() const noexcept
            {
                return obase_;
            }
        ...
        public:
            ...
            */
            ...
            POSEIDON_NODISCARD inline auto base_B() const noexcept
            {
                return base_B_.get();
            }

            POSEIDON_NODISCARD inline auto base_Bsk() const noexcept
            {
            ...
            POSEIDON_NODISCARD inline auto base_t_gamma() const noexcept
            {
                return base_t_gamma_.get();
            }

            POSEIDON_NODISCARD inline auto &m_tilde() const noexcept
            {
                return m_tilde_;
            }

            POSEIDON_NODISCARD inline auto &m_sk() const noexcept
            {
                return m_sk_;
            }

            POSEIDON_NODISCARD inline auto &t() const noexcept
            {
                return t_;
            }

            POSEIDON_NODISCARD inline auto &gamma() const noexcept
            {
                return gamma_;
            }

            POSEIDON_NODISCARD inline auto &inv_q_last_mod_t() const noexcept
            {

...
namespace poseidon
{
    namespace util
    {
        ...
        public:
            ...
            POSEIDON_NODISCARD inline ReaderLock acquire_read()
            {
                return ReaderLock(rw_lock_mutex_);
            }

            POSEIDON_NODISCARD inline WriterLock acquire_write()
            {
...
namespace poseidon
{
    namespace util
    {
        ...
        public:
            ...
            POSEIDON_NODISCARD inline bool owns_lock() const noexcept
            {
        ...
        public:
            ...
            POSEIDON_NODISCARD inline ReaderLock acquire_read() noexcept
            {
                return ReaderLock(*this);
            }

            POSEIDON_NODISCARD inline WriterLock acquire_write() noexcept
            {

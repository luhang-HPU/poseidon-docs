...
namespace poseidon
{
    namespace util
    {
        POSEIDON_NODISCARD inline std::string poly_to_hex_string(
        ...
        POSEIDON_NODISCARD inline std::string poly_to_dec_string(
        ...
        POSEIDON_NODISCARD inline auto allocate_poly(
        ...
        POSEIDON_NODISCARD inline auto allocate_zero_poly(
            std::size_t coeff_count, std::size_t coeff_uint64_count, MemoryPool &pool)
        {
            return allocate_zero_uint(util::mul_safe(coeff_count, coeff_uint64_count), pool);
        }

        POSEIDON_NODISCARD inline auto allocate_poly_array(
        ...
        POSEIDON_NODISCARD inline auto allocate_zero_poly_array(
            std::size_t poly_count, std::size_t coeff_count, std::size_t coeff_uint64_count, MemoryPool &pool)
        {

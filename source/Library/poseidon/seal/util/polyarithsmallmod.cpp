...
namespace poseidon
{
    namespace util
    {
            ...
            CoeffIter result)
        {
            ...
            POSEIDON_ITERATE(iter(operand1, operand2, result), coeff_count, [&](auto I) {
#ifdef POSEIDON_DEBUG
                ...
                get<2>(I) = POSEIDON_COND_SELECT(sum >= modulus_value, sum - modulus_value, sum);
            });
#endif
        }
            ...
            CoeffIter result)
        {
            ...
            POSEIDON_ITERATE(iter(operand1, operand2, result), coeff_count, [&](auto I) {
                ...
                get<2>(I) = POSEIDON_COND_SELECT(tmp3 >= modulus_value, tmp3 - modulus_value, tmp3);
            });
#endif
        }
        ...
        uint64_t poly_infty_norm_coeffmod(ConstCoeffIter operand, size_t coeff_count, const Modulus &modulus)
        {
            ...
            uint64_t result = 0;
            POSEIDON_ITERATE(operand, coeff_count, [&](auto I) {

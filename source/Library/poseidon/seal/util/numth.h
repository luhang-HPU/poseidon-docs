...
namespace poseidon
{
    namespace util
    {
        ...
        POSEIDON_NODISCARD std::vector<std::uint64_t> multiplicative_orders(
            std::vector<std::uint64_t> conjugate_classes, std::uint64_t modulus);

        POSEIDON_NODISCARD std::vector<std::uint64_t> conjugate_classes(
        ...
        POSEIDON_NODISCARD auto decompose_babystep_giantstep(
        ...
        POSEIDON_NODISCARD std::vector<Modulus> get_primes(std::uint64_t factor, int bit_size, std::size_t count);
        POSEIDON_NODISCARD std::vector<Modulus> get_primes_raise_no_check(uint64_t factor, int bit_size, size_t count);

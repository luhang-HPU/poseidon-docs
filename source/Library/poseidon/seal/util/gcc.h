...
#pragma GCC error "g++-6 cannot compile Microsoft POSEIDON as C++17; set CMake build option `POSEIDON_USE_CXX17' to OFF"
#endif
...
#define POSEIDON_SUB_BORROW_UINT64(operand1, operand2, borrow, result) _subborrow_u64(borrow, operand2, operand1, result)

...
namespace poseidon
{
    namespace util
    {
        ...
        public:
            ...
            POSEIDON_NODISCARD inline seal_byte *data() noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline const seal_byte *data() const noexcept
            {
                return data_;
            }

            POSEIDON_NODISCARD inline MemoryPoolItem *&next() noexcept
            {
                return next_;
            }

            POSEIDON_NODISCARD inline const MemoryPoolItem *next() const noexcept
            {
                return next_;
            }
        ...
        public:
            ...
            POSEIDON_NODISCARD Pointer<seal_byte> get_for_byte_count(std::size_t byte_count) override;

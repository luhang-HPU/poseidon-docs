...
//#include "poseidon/seal/version.h"
...
namespace poseidon
{
    ...
    namespace util
    {
        namespace ztools
        {
            ...
            POSEIDON_NODISCARD SizeT deflate_size_bound(SizeT in_size);
        } // namespace ztools
    } // namespace util
    ...
    */
    ...
    public:
        ...
        */
        POSEIDON_NODISCARD inline T *begin() noexcept
        {
            return data_.get();
        }
        ...
        */
        POSEIDON_NODISCARD inline const T *begin() const noexcept
        {
            return cbegin();
        }
        ...
        Returns a constant pointer to the beginning of the array data.
        */
        POSEIDON_NODISCARD inline const T *cbegin() const noexcept
        {
            return data_.get();
        }
        ...
        */
        POSEIDON_NODISCARD inline T *end() noexcept
        {
            return begin() + size_;
        }
        ...
        */
        POSEIDON_NODISCARD inline const T *end() const noexcept
        {
            return cend();
        }
        ...
        Returns a constant pointer to the end of the array data.
        */
        POSEIDON_NODISCARD inline const T *cend() const noexcept
        {
            return cbegin() + size_;
        }
#ifdef SEAL_USE_MSGSL
        ...
        */
        POSEIDON_NODISCARD inline gsl::span<T> span()
        {
        ...
        */
        POSEIDON_NODISCARD inline bool empty() const noexcept
        {
            return (size_ == 0);
        }
...
//        }
    ...
    private:
        ...
        /*
        void load_members(std::istream &stream, POSEIDON_MAYBE_UNUSED SEALVersion version, std::size_t in_size_bound)
        {
            auto old_except_mask = stream.exceptions();
            try
            {

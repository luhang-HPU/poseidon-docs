...
//#include "poseidon/seal/serialization.h"
#include "poseidon/seal/util/defines.h"
#include "poseidon/seal/util/hestdparms.h"
#include "poseidon/seal/util/uintcore.h"
#include "poseidon/seal/util/ztools.h"
#include <array>
#include <cstddef>
#include <cstdint>
#include <iostream>
...
namespace poseidon
{
    ...
    */
    ...
    public:
        ...
        */
        POSEIDON_NODISCARD inline int bit_count() const noexcept
        {
            return bit_count_;
        }
        ...
        */
        POSEIDON_NODISCARD inline std::size_t uint64_count() const noexcept
        {
        ...
        */
        POSEIDON_NODISCARD inline const uint64_t *data() const noexcept
        {
            return &value_;
        }
        ...
        */
        POSEIDON_NODISCARD inline std::uint64_t value() const noexcept
        {
            return value_;
        }
        ...
        */
        POSEIDON_NODISCARD inline auto &const_ratio() const noexcept
        {
            return const_ratio_;
        }
        ...
        */
        POSEIDON_NODISCARD inline bool is_zero() const noexcept
        {
            return value_ == 0;
        }
        ...
        */
        POSEIDON_NODISCARD inline bool is_prime() const noexcept
        {
            return is_prime_;
        }
...
//
//            return util::safe_cast<std::streamoff>(util::add_safe(sizeof(Serialization::POSEIDONHeader), members_size));
//        }
...
//        }
        ...
        Microsoft POSEIDON, if the loaded data is invalid, or if decompression failed
        @throws std::runtime_error if I/O operations failed
        */
...
//        }
    ...
    Microsoft POSEIDON when constructing a POSEIDONContext object. Normal users should not
    ...
    */
    ...
    and is the default security level enforced by Microsoft POSEIDON when constructing
    ...
    */
    ...
    public:
        ...
        */
        POSEIDON_NODISCARD static constexpr int MaxBitCount(
        ...
        */
        POSEIDON_NODISCARD static std::vector<Modulus> BFVDefault(
        ...
        */
        POSEIDON_NODISCARD static std::vector<Modulus> Create(std::size_t poly_modulus_degree, std::vector<int> bit_sizes);
        ...
        @throws std::logic_error if not enough suitable primes could be found
        */
        POSEIDON_NODISCARD static std::vector<Modulus> Create(
    ...
    */
    ...
    public:
        ...
        */
        ...
        @throws std::logic_error if not enough suitable primes could be found
        */
        POSEIDON_NODISCARD static inline std::vector<Modulus> Batching(

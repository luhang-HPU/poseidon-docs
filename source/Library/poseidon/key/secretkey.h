...
//#include "poseidon/seal/valcheck.h"
...
//        POSEIDON_NODISCARD  inline PolyIter poly_itr()
//        {
//
//            auto p = PolyIter(sk_.data(), sk_.coeff_count_, coeff_modulus_size_);
//            return p;
//        }
...
//        }
        ...
        */
        POSEIDON_NODISCARD inline auto &data() noexcept
        {
            return sk_;
        }
        ...
        */
        POSEIDON_NODISCARD inline auto &data() const noexcept
        {
            return sk_;
        }
...
//        }
        ...
        */
        POSEIDON_NODISCARD inline auto &parms_id() noexcept
        {
            return sk_.parms_id();
        }
        ...
        @see EncryptionParameters for more information about parms_id.
        */
        POSEIDON_NODISCARD inline auto &parms_id() const noexcept
        {
            return sk_.parms_id();
        }

...
namespace poseidon
{
    ...
    */
    ...
    public:
        ...
        */
        POSEIDON_NODISCARD inline pt_coeff_type *data()
        {
            return data_.begin();
        }
        ...
        */
        POSEIDON_NODISCARD inline const pt_coeff_type *data() const
        {
            return data_.cbegin();
        }
#ifdef SEAL_USE_MSGSL
        ...
        */
        POSEIDON_NODISCARD inline bool operator==(const Plaintext &compare) const
        {
            ...
            bool parms_id_compare = ((is_ntt_form() && compare.is_ntt_form() ) ||
                                    (!is_ntt_form() && !compare.is_ntt_form())) && (params_id_ == compare.params_id_);
        ...
        */
        POSEIDON_NODISCARD inline std::size_t capacity() const noexcept
        {
        ...
        */
        POSEIDON_NODISCARD inline std::size_t coeff_count() const noexcept
        {
            return coeff_count_;
        }
        ...
        */
//        POSEIDON_NODISCARD inline std::streamoff save_size(
...
//        }
//
        POSEIDON_NODISCARD inline  RNSPoly &poly () {
            return  polys_;
        }

        POSEIDON_NODISCARD inline  const RNSPoly &poly () const{
            return  polys_;
        }

        POSEIDON_NODISCARD inline bool is_valid() const{
            return params_id_ != parms_id_zero;
        }

        inline void compute_ckks_hardware_id() const{
            polys_.compute_ckks_hardware_id();

        }

        POSEIDON_NODISCARD inline bool &need_reszie() {
            return need_resize_;
        }

        POSEIDON_NODISCARD inline const bool &need_resize() const{
            return need_resize_;
        }

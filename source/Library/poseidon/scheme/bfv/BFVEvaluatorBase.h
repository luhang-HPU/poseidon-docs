...
#ifndef POSEIDON_BFVEVALUATORBASE_H
#define POSEIDON_BFVEVALUATORBASE_H
...
namespace poseidon{
    ...
    protected:
        inline explicit BFVEvaluatorBase(const PoseidonContext &context,MemoryPoolHandle pool = MemoryManager::GetPool())

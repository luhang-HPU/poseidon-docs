...
1. `TimeStacs` , the timer to record the total time spent on the homomorphic computation.
...
3. `GetPrecisionStats`, the function for measurement of precision for `CKKS`
